        ...
        <div class="container">
            <div class="row">
                ...
                <div>
                    ...
                    <p class="mt5 mb20 tc-green">Make your customers shop using vouchers</p>
                </div>
            </div>
            <hr class="uline-grey">
            <div class="mt50 row">
            ...
            <div class="mt30 row">
                ...
                <div class="w80">
                    <input
                        class="form-text"
                        type="text"
                        placeholder="Masukkan Voucher Name"
                        minlength="5"
                        maxlength="20"
                    >
                </div>
            ...
            <div class="mt30 row">
                ...
                <div class="w80">
                    <input
                        class="form-text"
                        type="text"
                        placeholder="Masukkan Voucher Description"
                        maxlength="5000"
                    >
                </div>
            </div>
            ...
            <div class="mt30 row">
                ...
                <div class="w80">
                    <input
                        class="form-text"
                        type="text"
                        placeholder="Masukkan Minimal Transaction"
                    >
                </div>
            </div>
            <div class="mt30 row">
...
export default {
	name: 'add-voucher',
    methods: {
    hitungKarakter(inputElement) {
      var karakterMasukan = inputElement.value.length;
      document.getElementById("count").textContent = karakterMasukan;
    }
  }
